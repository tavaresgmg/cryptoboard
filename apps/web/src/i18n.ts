...
const messages = {
  es: {
    ...
    auth: {
      ...
      resetSubtitle: "Ingresa tu nueva contraseña para completar el proceso.",
      resetAction: "Restablecer contraseña",
      loginFailed: "No se pudo iniciar sesión",
      registerFailed: "No se pudo crear la cuenta",
      forgotRequestSent: "Si el correo existe, enviaremos instrucciones de recuperación",
      forgotRequestFailed: "No se pudo solicitar la recuperación de contraseña",
      resetSucceeded: "Contraseña restablecida correctamente",
      resetFailed: "No se pudo restablecer la contraseña",
      invalidCredentials: "Credenciales inválidas",
      emailAlreadyRegistered: "El correo ya está registrado",
      invalidOrExpiredResetToken: "El token de recuperación es inválido o expiró",
      passwordsDoNotMatch: "Las contraseñas no coinciden",
      resetTokenMissing: "El enlace de recuperación es inválido o está incompleto"
    },
    nav: {
      appName: "CryptoBoard",
    ...
    onboarding: {
      ...
      chooseAvatarFile: "Elegir archivo",
  ...
  en: {
    ...
    auth: {
      ...
      forgotRequestSent: "If the email exists, we will send reset instructions",
      forgotRequestFailed: "Unable to request password reset",
      resetSucceeded: "Password reset successfully",
      resetFailed: "Unable to reset password",
      invalidCredentials: "Invalid credentials",
      emailAlreadyRegistered: "Email is already registered",
      invalidOrExpiredResetToken: "Reset token is invalid or expired",
      passwordsDoNotMatch: "Passwords do not match",
      resetTokenMissing: "Reset link is invalid or incomplete"
    },
    nav: {
      appName: "CryptoBoard",
  ...
  "pt-BR": {
    ...
    auth: {
      ...
      resetSubtitle: "Informe sua nova senha para concluir a redefinição.",
      resetAction: "Redefinir senha",
      loginFailed: "Não foi possível entrar",
      registerFailed: "Não foi possível criar a conta",
      forgotRequestSent: "Se o e-mail existir, enviaremos as instruções de recuperação",
      forgotRequestFailed: "Não foi possível solicitar a recuperação de senha",
      resetSucceeded: "Senha redefinida com sucesso",
      resetFailed: "Não foi possível redefinir a senha",
      invalidCredentials: "Credenciais inválidas",
      emailAlreadyRegistered: "Este e-mail já está cadastrado",
      invalidOrExpiredResetToken: "O token de recuperação é inválido ou expirou",
      passwordsDoNotMatch: "As senhas não conferem",
      resetTokenMissing: "O link de recuperação é inválido ou está incompleto"
    },
    nav: {
      appName: "CryptoBoard",
      toggleSidebar: "Alternar barra lateral",
    ...
    onboarding: {
      ...
      avatarLabel: "Foto de perfil",
      chooseAvatarFile: "Escolher arquivo",
